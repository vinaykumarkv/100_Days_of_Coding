...
def check_word(Word,blank):
    User_Word = input ("Please guess the alphabet in the word?: ")
    guess = ""
    position =""
    b = blank
    flag = 0
...
while check_blank(blank) != 0 and attempt != 7:
    
    
    blank1 = check_word(Word,blank)
    print(blank)
    print(blank1)
    print(check_blank(blank))
...
if check_blank(blank) ==  0:
    print ("you won boy!!")
else:
    print("Death!!")
    print(f"The word was {Word}")
    
#my code might be little scrappy. but I am still a learning. tried my best. I will get better as I go on :)
